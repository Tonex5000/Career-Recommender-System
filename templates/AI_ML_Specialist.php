				...
				<div class="row">
					...
					<!-- main blog -->
						...
						<div class="blog-post" style= text-align:justify; ">
                            ...
                            <div class="row">
							<h2>Salary</h2>
							<p style="font-size:16px;">According to online sources, the entry-level Artificial Intelligence/ Machine Learning salary in Nigeria for almost 40% of professionals earn around ₦250,000, mid-level and senior-level artificial intelligence salary could earn more than ₦400,000 in Nigeria.</p>
                            </div>
                            <!-- /row -->
